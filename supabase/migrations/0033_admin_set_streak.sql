-- ============================================================================
-- 1% Better — Owner-only: set any account's daily streak
--
-- Sets current_streak, bumps longest_streak if needed, and sets
-- last_action_date to today so the new streak reads as active/current.
